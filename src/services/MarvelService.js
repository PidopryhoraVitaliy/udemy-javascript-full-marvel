...
const useMarvelService = () => {
    ...
    const { request, clearError, process: proc, setProcess } = useHttp();
    ...
    return { clearError, proc, setProcess, getAllCharacters, getCharacter, getCharacterByName, getAllComics, getComic }
}
